...
prm_interest_folder = '/mmu_nlp_ssd/xiayu12/LIBER_ours_train/PRM_point/ml_prm'
all = {}
...
print(len(all))
path = '/mmu_nlp_ssd/xiayu12/LIBER_ours_train/PRM_point/ml_prm/all_max_prm_interest.json'
