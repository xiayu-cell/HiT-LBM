...
prm_interest_folder = '/mmu_nlp_ssd/xiayu12/LIBER_ours_train/PRM_point/amz_prm/all_final_prm_interest.json'
...
print(len(data_list))
save_path = '/mmu_nlp_ssd/xiayu12/LIBER_ours_train/PRM_point/amz_prm/sft_final_prm_data.json'
