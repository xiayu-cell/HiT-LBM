...
# 计算llm预测的ans的指标：AUC，ACC


with open('/mmu_nlp_ssd/xiayu12/LIBER_ours_train/PRM_point/amz/prm_data.json','r',encoding='utf-8') as f:
    prm_data = json.load(f)
prediction_folder = '/mmu_nlp_ssd/xiayu12/LIBER_ours_train/PRM_point/amz'
all_prediction = {}
total = 0
pos = 0
...
path = '/mmu_nlp_ssd/xiayu12/LIBER_ours_train/PRM_point/amz/prompt_prm_data.json'
