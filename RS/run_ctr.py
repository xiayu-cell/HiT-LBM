...
# Training args
data_dir = '/mmu_vcg2_wjc_ssd/xiayu12/LIBER_ours_train/data/ml-1m/proc_data/block_len_20'
task_name = 'ctr'
# dataset_name = 'amz'
dataset_name = 'ml-1m'
aug_prefix = 'bge_avg'
...
for batch_size in [256,512, 2048, 128, 1024,]:
    for lr in ['1e-4', '5e-4', '1e-3']:
        for export_num in [2]:
            for specific_export_num in [2]:
                # if (lr == '1e-4' or lr == '5e-5') and batch_size == 256:
                    # continue
