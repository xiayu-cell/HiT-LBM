...
from models_xiayu_score import DeepInterestNet, DCN, DeepFM, DIEN, xDeepFM, FiBiNet, FiGNN, AutoInt
...
def train(args):
    ...
    test_loader = Data.DataLoader(dataset=test_set, batch_size=args.batch_size, shuffle=False,num_workers=4)
