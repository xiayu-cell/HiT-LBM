...
prm_interest_folder = '/mmu_nlp_ssd/xiayu12/LIBER_ours_train/PRM/ml-1m_prm'
all = {}
...
print(len(all))
path = '/mmu_nlp_ssd/xiayu12/LIBER_ours_train/PRM/ml-1m_prm/all_min_prm_interest.json'
