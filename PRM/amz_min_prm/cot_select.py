...
prm_interest_folder = '/mmu_nlp_ssd/xiayu12/LIBER_ours_train/PRM/amz_min_prm'
all = {}
...
print(len(all))
path = '/mmu_nlp_ssd/xiayu12/LIBER_ours_train/PRM/amz_min_prm/all_min_prm_interest.json'
