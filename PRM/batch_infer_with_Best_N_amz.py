...
def update_prm(block_id):
    ...
    block_interest_folder = '/PRM_point/amz_prm'
    if block_id >= 0:
        cur_block_interest = {}
    ...
    with open(f'/PRM_point/amz_prm/prm_interest_{block_id}.json', 'w') as f:
...
def run_inference(model_path,block_id,batch, bs, thread_id):
    ...
    with open(f'/PRM_point/amz_prm/interest_{block_id}_{thread_id}.json', 'w') as f:
...
if __name__ == "__main__":
    prompt_path = '/data/amz/proc_data/block_len_50/all_prompt.hist'
    model_path = '/checkpoints/Qwen/Qwen2___5-7B-Instruct'
    seq_prm_path = '/PRM/checkpoint/amz/cls_epoch_2_threshold_0.5.pth'
    point_prm_path = '/PRM_point/ckp/amz/cls_epoch_0_threshold_0.5.pth'
    bge_path = '/llm/bge-m3'
