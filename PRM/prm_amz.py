...
def train():
    ...
    emb_path = '/PRM_point/amz/bge_avg_cur_emb.sum'
    label_path = '/PRM_point/amz/prm_train.json' 
    threshold = 0.5
    ...
    for epoch in range(num_epochs):
        ...
        # 保存模型权重
        torch.save(model.state_dict(), f'/PRM_point/ckp/amz/cls_epoch_{epoch}_threshold_{threshold}.pth')
        ...
        results_df.to_csv(f'/PRM_point/test_amz_prm_epoch_{epoch}.csv')
