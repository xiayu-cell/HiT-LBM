...
def train():
    ...
    emb_path = '/mmu_nlp_ssd/xiayu12/LIBER_ours_train/PRM/amz/block_len_50/bge_avg_emb.sum'
    label_path = '/mmu_nlp_ssd/xiayu12/LIBER_ours_train/PRM/amz/block_len_50/prm_train.json' 
    threshold = 0.5
    ...
    for epoch in range(num_epochs):
        ...
        # 保存模型权重
        torch.save(model.state_dict(), f'/mmu_nlp_ssd/xiayu12/LIBER_ours_train/PRM/checkpoint/amz/cls_epoch_{epoch}_threshold_{threshold}.pth')
        ...
        results_df.to_csv(f'/mmu_nlp_ssd/xiayu12/LIBER_ours_train/PRM/test_amz_prm_epoch_{epoch}.csv')
