...
def update_prm(block_id):
    ...
    block_interest_folder = '/PRM_point/ml_prm'
    if block_id >= 0:
        cur_block_interest = {}
    ...
    with open(f'/PRM_point/ml_prm/prm_interest_{block_id}.json', 'w') as f:
...
def run_inference(model_path,block_id,batch, bs, thread_id):
    ...
    with open(f'/PRM_point/ml_prm/interest_{block_id}_{thread_id}.json', 'w') as f:
...
if __name__ == "__main__":
    ...
    seq_prm_path = '/PRM/checkpoint/cls_epoch_3_threshold_0.5.pth'
    point_prm_path = '/PRM_point/ckp/ml-1m/cls_epoch_8_threshold_0.5.pth'
    bge_path = '/llm/bge-m3'
