...
def main(knowledge_path, data_path, model_name, batch_size, aggregate_type):
    ...
    save_json(hist_vec_dict, os.path.join(data_path, '{}_{}_final_augment.hist'.format(model_name, aggregate_type)))
...
if __name__ == '__main__':
    ...
    KLG_DATA_DIR = '/mmu_vcg2_wjc_ssd/xiayu12/LIBER_ours_train/preference_generation/ml-1m/block_len_100/summary'
    SAVE_DATA_DIR = '../data'
    # DATA_SET_NAME = 'amz'
    DATA_SET_NAME = 'ml-1m'
    KLG_PATH = KLG_DATA_DIR
    DATA_PATH = os.path.join(SAVE_DATA_DIR, DATA_SET_NAME, "proc_data/block_len_100")
    # MODEL_NAME = 'chatglm'
    # MODEL_NAME = 'chatglm2'
