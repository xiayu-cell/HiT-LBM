import json
import os
item_knowledge_folder = '/preference_generation/ml-1m/block_len_50/item_knowledge/14B'
all = {}
...
print(len(all))
path = '/preference_generation/ml-1m/block_len_50/item_knowledge/14B/all_item_knowledge.json'
