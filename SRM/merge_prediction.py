...
with open('/PRM/amz/block_len_50/prm_data.json','r',encoding='utf-8') as f:
    prm_data = json.load(f)
prediction_folder = '/PRM/amz/block_len_50'
all_prediction = {}
total = 0
pos = 0
...
path = '/PRM/ml-1m/block_len_50/final_prm_data.json'
