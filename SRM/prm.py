...
def train():
    ...
    emb_path = '/PRM/amz/block_len_50/bge_avg_emb.sum'
    label_path = '/PRM/amz/block_len_50/prm_train.json' 
    threshold = 0.5
    ...
    for epoch in range(num_epochs):
        ...
        # 保存模型权重
        torch.save(model.state_dict(), f'/PRM/checkpoint/amz/cls_epoch_{epoch}_threshold_{threshold}.pth')
        ...
        results_df.to_csv(f'/PRM/test_amz_prm_epoch_{epoch}.csv')
